                ...
                if ($result != null) {
                    foreach ($result as $row) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="../Views/update.php?id=<?php echo $row['id']; ?>"><button class="btn btn-warning">Edit</button></a>
                                <a href="../Controller/delete.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger">Hapus</button></a>
                            </td>
                        </tr>
                        <?php
                        $no++;
